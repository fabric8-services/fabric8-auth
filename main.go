...
func main() {
	...
	userCtrl := controller.NewUserController(service, loginService, appDB, tokenManager, config)
	...
	userInfoCtrl := controller.NewUserinfoController(service, loginService, appDB, tokenManager)
