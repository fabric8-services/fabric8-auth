...
const (
	expectedDefaultConfDevModeErrorMessage  = "Error: /etc/fabric8/service-account-secrets.conf is not used; /etc/fabric8/oso-clusters.conf is not used; developer Mode is enabled; default service account private key is used; default service account private key ID is used; default user account private key is used; default user account private key ID is used; default DB password is used; default OAuth Service client secret is used; default GitHub client secret is used; no restrictions for valid redirect URLs; notification service url is empty; OSO Reg App url is empty; OSO Reg App admin username is empty; OSO Reg App admin token is empty; environment is expected to be set to 'production' or 'prod-preview'; Sentry DSN is empty"
	expectedDefaultConfProdModeErrorMessage = "Error: /etc/fabric8/service-account-secrets.conf is not used; /etc/fabric8/oso-clusters.conf is not used; default service account private key is used; default service account private key ID is used; default user account private key is used; default user account private key ID is used; default DB password is used; default OAuth Service client secret is used; default GitHub client secret is used; notification service url is empty; OSO Reg App url is empty; OSO Reg App admin username is empty; OSO Reg App admin token is empty; environment is expected to be set to 'production' or 'prod-preview'; Sentry DSN is empty"
)
