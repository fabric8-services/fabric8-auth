...
const (
	expectedDefaultConfDevModeErrorMessage  = "Error: /etc/fabric8/service-account-secrets.conf is not used; developer Mode is enabled; default service account private key is used; default service account private key ID is used; default user account private key is used; default user account private key ID is used; default DB password is used; default auth provider client secret is used; default GitHub client secret is used; no restrictions for valid redirect URLs; environment is expected to be set to 'production' or 'prod-preview'; Sentry DSN is empty"
	expectedDefaultConfProdModeErrorMessage = "Error: /etc/fabric8/service-account-secrets.conf is not used; default service account private key is used; default service account private key ID is used; default user account private key is used; default user account private key ID is used; default DB password is used; default auth provider client secret is used; default GitHub client secret is used; environment is expected to be set to 'production' or 'prod-preview'; Sentry DSN is empty"
)
