...
func (rest *TestCollaboratorsREST) SecuredController() (*goa.Service, *CollaboratorsController) {
	svc := testsupport.ServiceAsSpaceUser("Collaborators-Service", testtoken.NewManagerWithPrivateKey(), rest.testIdentity1, &DummySpaceAuthzService{rest})
...
func (rest *TestCollaboratorsREST) TestRemoveCollaboratorsUnauthorizedIfCurrentUserIsNotCollaborator() {
	// given
	svc := testsupport.ServiceAsSpaceUser("Collaborators-Service", testtoken.NewManagerWithPrivateKey(), rest.testIdentity2, &DummySpaceAuthzService{rest})
