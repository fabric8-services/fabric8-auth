...
const (
	...
	varOAuthServiceTestsDisabled       = "oauth.service.tests.disabled"
	...
	// OAuthService
	varOAuthServiceSecret           = "oauth.service.secret"
	varOAuthServiceClientID         = "oauth.service.client.id"
	varOAuthServiceDomainPrefix     = "oauth.service.domain.prefix"
	varOAuthServiceRealm            = "oauth.service.realm"
	varOAuthServiceTesUserName      = "oauth.service.testuser.name"
	varOAuthServiceTesUserSecret    = "oauth.service.testuser.secret"
	varOAuthServiceTesUser2Name     = "oauth.service.testuser2.name"
	varOAuthServiceTesUser2Secret   = "oauth.service.testuser2.secret"
	varOAuthServiceURL              = "oauth.service.url"
	varOAuthServiceEndpointAdmin    = "oauth.service.endpoint.admin"
	varOAuthServiceEndpointAuth     = "oauth.service.endpoint.auth"
	varOAuthServiceEndpointToken    = "oauth.service.endpoint.token"
	varOAuthServiceEndpointUserinfo = "oauth.service.endpoint.userinfo"
	varOAuthServiceEndpointBroker   = "oauth.service.endpoint.broker"
	varOAuthServiceEndpointAccount  = "oauth.service.endpoint.account"
	varOAuthServiceEndpointLogout   = "oauth.service.endpoint.logout"
