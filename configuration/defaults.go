...
-----END RSA PUBLIC KEY-----`
	...
	defaultOAuthServiceClientID     = "fabric8-online-platform"
	defaultOAuthServiceSecret       = "7a3d5a00-7f80-40cf-8781-b5b6f2dfd1bd"
	defaultPublicOauthClientID      = "740650a2-9c44-4db5-b067-a3d1b2cd2d01"
	defaultOAuthServiceDomainPrefix = "sso"
	defaultOAuthServiceRealm        = "fabric8"
	...
	defaultOAuthServiceTesUserName    = "testuser"
	defaultOAuthServiceTesUserSecret  = "testuser"
